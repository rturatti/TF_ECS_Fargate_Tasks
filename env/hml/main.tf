...
module "infra" {
  ...
  vpc_name                 = "homolog"
  IAM_Role_Name            = "homolog"
  ecs_cluster_name         = "homolog"
...
module "fargate-tasks-04" {
  source                        = "../../modules/fargate-tasks"
  vpc_id                        = module.infra.VPC_ID
  private_subnets               = module.infra.PRIVATE_SUBNETS
  public_subnets                = module.infra.PUBLIC_SUBNETS
  container_name                = "lab-app-04"
  task_network_mode             = "awsvpc"
  task_role_arn                 = module.infra.task_role_arn
  task_cpu                      = 256
  task_memory                   = 512
...
module "fargate-tasks-05" {
  source                        = "../../modules/fargate-tasks"
  vpc_id                        = module.infra.VPC_ID
  private_subnets               = module.infra.PRIVATE_SUBNETS
  public_subnets                = module.infra.PUBLIC_SUBNETS
  container_name                = "lab-app-05"
  task_network_mode             = "awsvpc"
  task_role_arn                 = module.infra.task_role_arn
  task_cpu                      = 256
  task_memory                   = 512
...
module "fargate-tasks-06" {
  source                        = "../../modules/fargate-tasks"
  vpc_id                        = module.infra.VPC_ID
  private_subnets               = module.infra.PRIVATE_SUBNETS
  public_subnets                = module.infra.PUBLIC_SUBNETS
  container_name                = "lab-app-06"
  task_network_mode             = "awsvpc"
  task_role_arn                 = module.infra.task_role_arn
  task_cpu                      = 256
  task_memory                   = 512
...
output "DNS_alb_app-04" {
  value = module.fargate-tasks-04.DNS_LB
}

output "DNS_alb_app-05" {
  value = module.fargate-tasks-05.DNS_LB
}

output "DNS_alb_app-06" {
  value = module.fargate-tasks-06.DNS_LB
}